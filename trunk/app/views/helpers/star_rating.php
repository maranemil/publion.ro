...
{
    public $helpers = array('Head', 'Util', 'Page');

    /**
     * Pixels of star width
     */
    public $_star_width = 25;
     ...
     */
    public function display($value, $url)
    {
        static $index = 0;
        $index++;
    ...
    public function change($dom_id, $score)
    {
        $width = $this->_width($score);
    ...
    public function highlight($dom_id, $duration = 0.3)
    {
