...
class UploadComponent extends Object
{
    ...
    public function uploadNewFile()
    {
        ...
        if (!is_dir($destPath) && !mkdir($destPath) && !is_dir($destPath)) {
        ...
        */
        ...
        if (strpos($_FILES['data']['type']['images']['File'], "jpeg") !== false) {
            //image/jpeg
            $source = imagecreatefromjpeg($filename);
        } else if (strpos($_FILES['data']['type']['images']['File'], "gif") !== false) {
            //image/jpeg
            $source = imagecreatefromgif($filename);
        } else if (strpos($_FILES['data']['type']['images']['File'], "png") !== false) {
            //image/jpeg
