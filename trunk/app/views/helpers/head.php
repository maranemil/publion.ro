...
{
    public $helpers = array('Html', 'Javascript', 'Util');

    public $_library; //static array of items to be included
     ...
     * @param null $htmlAttributes
     */
    public function css($file, $htmlAttributes = null)
    {
     ...
     * @param null $htmlAttributes
     */
    public function cssblock($css, $htmlAttributes = null)
    {
     ...
     */
    public function jsblock($javascript)
    {
     ...
     */
    public function event($css, $event, $jscode)
    {
     ...
     */
    public function meta($htmlAttributes)
    {
     ...
     */
    public function refresh($url, $seconds = 10, $is_cake_url = true)
    {
        if ($is_cake_url) {
     ...
     * @param array $htmlAttributes Array of html attributes of meta tag
     */
    public function link($htmlAttributes)
    {
        ...
        foreach ($this->_library as $l) {
            ...
            switch ($l[1]) {
                ...
                case 'raw':
                    ...
                    break;
                case 'cssblock':
                    echo '<style "' . $this->Util->parse_attributes($l[2]) . " ><!--{$l[0]}--></style>";
                    break;
                default:
     ...
     * @access private
     */
    public function _register($item)
    {
    ...
    public function _codeBlock($jsblock)
    {
        $jsblock = "<!--\n$jsblock\n-->";
