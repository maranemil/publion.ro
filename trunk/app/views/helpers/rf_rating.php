...
class RfRatingHelper extends Helper
{
    ...
    public $_voteUrl = '/ratings/vote/';

    /** list of 'hints' to display for rating */
    public $_hints = array('Easy', 'Okay', 'Some difficulty', 'Use the force', 'You must be kidding');

    /** show hint or not */
    public $_showHints = true;
     ...
     */
    public function ratingBar($info, $text = false)
    {
