...
class PaginationHelper extends Helper
{
     ...
     *
     * @return false|string the html string for modifying the number of results per page
     **/
    public function resultsPerPage($text = null, $separator = null, $escapeTitle = true)
    {
     ...
     * @param string
     *
     * @return false|string the html string for the current result set.
     **/
    public function result($text = "Results per page: ", $of = " of ", $inbetween = "-")
    {
        if (empty($this->_pageDetails)) {
            return false;
        }
     ...
     **/
    public function prevPage($text = 'prev', $escapeTitle = true, $htmlAttributes = "")
    {
        if (empty($this->_pageDetails)) {
            return false;
        }
     ...
     **/
    public function nextPage($text = 'next', $escapeTitle = true, $htmlAttributes = "")
    {
        if (empty($this->_pageDetails)) {
            return false;
        }
     ...
     * @return string html for link/text for next item
     **/
    public function firstPage($text = 'first', $escapeTitle = true)
    {
        if (empty($this->_pageDetails)) {
            return false;
        }
     ...
     * @return string html for link/text for next item
     **/
    public function lastPage($text = 'last', $escapeTitle = true)
    {
        if (empty($this->_pageDetails)) {
            return false;
        }
     ...
     **/
    public function _generateLink($title, $page = null, $escapeTitle, $AjaxDivUpdate = "content", $htmlAttributes = '')
    {
     ...
     * @return string html for link
     **/
    function __generateLink($title = "ErrorNeverBlank", $escapeTitle, $getParams = array("error" => "NeverEmpty"), $pageParams = array("error" => "NeverEmpty"), $AjaxDivUpdate = "content", $htmlAttributes = '')
    {
        $getString = array();
        $prettyString = array();
