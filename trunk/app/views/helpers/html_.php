...
class HtmlHelper extends Helper
{
    ...
    function checkbox($fieldName, $title = null, $htmlAttributes = null, $return = false)
    {
        ...
        if (isset($htmlAttributes['value'])) {
            ...
            $value1 = $db->boolean($value);
            $htmlAttributes['checked'] = $value1 ? 'checked' : null;
     ...
     *
     * @return string Value of the named tag.
     */
    ...
    /**
     * Returns false if given FORM field has no errors.
     * Otherwise, it returns the constant set in the array Model->validationErrors.
     *
    ...
    {
        return empty($this->validationErrors[$model][$field]) ? false : $this->validationErrors[$model][$field];
    }
    ...
    public function tagErrorMsg($field, $text)
    {
        ...
        if ((bool)$error === $this->tagIsInvalid($this->model, $this->field)) {
            return sprintf(
        ...
        if (is_array($options)) {
            ...
            foreach ($options as $key => $value) {
                if (!in_array($key, $exclude, true)) {
                    if (in_array($key, $minimizedAttributes, true) &&
                        ($value === 1 || $value === true || $value === 'true' || in_array($value, $minimizedAttributes, true))
                    ) {
                        $value = $key;
     ...
     */
    public function checkboxTag($fieldName, $title = null, $htmlAttributes = null, $return = false)
    {
    ...
    public function hiddenTag($tagName, $value = null, $htmlOptions = null)
    {
        ...
        return $this->output(
            sprintf(
                $this->tags['hidden'], $this->model,
                $this->field,
                $this->parseHtmlOptions($htmlOptions, null, '', ' ')
            ));
    }
     ...
     */
    public function inputTag($fieldName, $value, array $htmlAttributes, $return)
    {
        $this->setFormTag($tagName);
     ...
     */
    public function javascriptIncludeTag($url)
    {
     ...
     * @deprecated Moved to JavascriptHelper. Version 0.9.2.
     */
    public function javascriptTag($script)
    {
     ...
     */
    public function dayOptionTag($tagName, $value = null, $selected = null, $selectAttr = null, $optionAttr = null, $showEmpty = true)
    {
     ...
     * @deprecated  string $value
     */
    public function monthOptionTag($tagName, $value = null, $selected = null, $selectAttr = null, $optionAttr = null, $showEmpty = true)
    {
     ...
     * @deprecated  string $value
     */
    public function hourOptionTag($tagName, $value = null, $format24Hours = false, $selected = null, $selectAttr = null, $optionAttr = null, $showEmpty = true)
    {
        if ($format24Hours) {
     ...
     * @deprecated  string $value
     */
    public function minuteOptionTag($tagName, $value = null, $selected = null, $selectAttr = null, $optionAttr = null, $showEmpty = true)
    {
     ...
     * @noinspection PhpUnusedParameterInspection
     */
    public function meridianOptionTag($tagName, $value = null, $selected = null, $selectAttr = null, $optionAttr = null, $showEmpty = true)
    {
